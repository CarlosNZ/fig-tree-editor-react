...
// Formatting is owned by Prettier (.prettierrc.js), so no stylistic/layout
// rules live here.
export default tseslint.config(
  ...
  { ignores: ['build/', 'demo/', 'pack-output/', 'coverage/'] },
  {
    ...
    rules: {
      ...
      // Explicit `any` is used deliberately at the JER boundary (see CLAUDE.md);
      // surface as a warning, consistent with the unsafe-* family above.
